			...
			<div id="dt_basic_wrapper" class="dataTables_wrapper form-inline smart-form" role="grid">
				<div class="row table-filter-row">
					...
					<div class="action-bar col col-8">
						...
						<div class="col col-2">
							<a href="javascript:void(0);" class="btn btn-primary btn-sm" onclick="AddCategoryPopup('<?php echo site_url(array('AdminCategory','AddCategory')); ?>');">
								<i class="fa fa-plus" style="margin-right: 5px;"></i>Thêm danh mục
							</a>
						</div>
					</div>
				</div>
			<?php  $this->load->view('Admin/AdminCategory/CategoryList');
			?>
		</div>
		</div>
		</div>
