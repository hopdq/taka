...
class AdminProvider extends CI_Controller{
	...
	public function EditProvider() {
		$id = $this->input->post('proId', true);
		$code = $this->input->post('proCode', true);
		$name = $this->input->post('proName', true);
		$logoUrl = $this->input->post('proLogoUrl', true);
		$descript = $this->input->post('proDescription', true);
