...
<script src="<?php echo base_url('/application/Content/Js/app/AddProvider.model.js')?>"></script>
<script src="<?php echo base_url('/application/Content/Js/jquery.form.js')?>"></script>
<div id = "addingUserPage" ng-app="AddProviderApp">
	<input type = "hidden" name = "baseUrl" id = "baseUrl" value = "<?php echo base_url();?>"/>
	<div id = "addingUserPopup" ng-controller="AddProviderController">
		...
		<div role="content">
			...
			<div class="widget-body no-padding">
				...
				<form class="smart-form">
					<fieldset>
						...
						<section>
							<label class="label">Logo: </label>
								<label>
									<img id = "logoImg" ng-src= "{{pro.fullPath}}" alt = "Logo" width="60px" height="60px" />
								</label>
							</label>
						</section>
						<section>
					...
					<footer>
						<button type="submit" class="btn btn-primary" ng-click = "completeAddingProviderProcess();">
							Lưu lại
						</button>
					</footer>
				</form>
